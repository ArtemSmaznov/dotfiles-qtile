...
keys = [
    ...
    # Power Control
    Key([alt], "F4", lazy.spawn(dm + "dm-power"), desc="A logout menu"),
    KeyChord(
        [mod],
        "t",
        [
    ...
    KeyChord(
        ...
        [
            ...
            Key([], "r", lazy.spawn(dm + "dm-power reboot"), desc="Reboot"),
    ...
    KeyChord(
        ...
        "backslash",
        [
            Key([], "backslash", lazy.spawn(dm + "dm-notify recents")),
            Key([], "r", lazy.spawn(dm + "dm-notify recents")),
            Key([], "a", lazy.spawn(dm + "dm-notify context")),
            Key([], "c", lazy.spawn(dm + "dm-notify close")),
            Key([shift], "c", lazy.spawn(dm + "dm-notify clear")),
        ],
        mode="Notifications",
    ),
    # ░█▀▀░█▀▀░█▀▄░█▀▀░█▀▀░█▀█░█▀▀░█░█░█▀█░▀█▀
